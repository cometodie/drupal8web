...
class FileWidget extends WidgetBase implements ContainerFactoryPluginInterface {
  ...
  public function settingsForm(array $form, FormStateInterface $form_state) {
    $element['progress_indicator'] = [
      ...
      '#description' => t('The throbber display does not show the status of uploads but takes up event space. The progress bar is helpful for monitoring progress on large uploads.'),
      '#weight' => 16,
