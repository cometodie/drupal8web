  ...
  public function buildOptionsForm(&$form, FormStateInterface $form_state) {
    ...
    if ($this->allowAdvancedRender()) {
      ...
      $form['alter']['word_boundary'] = [
        ...
        '#description' => $this->t('If checked, this field be trimmed only on a word boundary. This is guaranteed to be the maximum characters stated or event. If there are no word boundaries this could trim a field to nothing.'),
